            ...
            if section == "timingpoints":
                ...
                if not section:
                    ...
                    if match:
                        ...
                        elif match.group(1).lower() in ["stackleniency", "distancespacing", "beatdivisor", "gridsize", "previewtime", "mode",
                                                        "hpdrainrate", "circlesize", "approachrate", "overalldifficulty", "slidermultiplier",
                                                        "slidertickrate"]:
